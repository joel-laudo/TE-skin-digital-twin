...
c      SP = 60000.d0
      if (tim.gt.163.0d0) then
        SP = 148000.d0
        Kp = 16.0d0
        Ki = 16.0d0
        Kd = 0.0d0
      else if (tim.gt.139.0d0) then
        SP = 137000.d0
        Kp = 16.0d0
        Ki = 16.0d0
        Kd = 0.0d0
      else if (tim.gt.120.0d0) then
        SP = 117000.d0
        Kp = 16.0d0
        Ki = 16.0d0
        Kd = 0.0d0
      else if (tim.gt.106.0d0) then
        SP = 107000.d0
        Kp = 16.0d0
        Ki = 16.0d0
        Kd = 0.0d0
      else if (tim.gt.92.0d0) then
        SP = 103000.d0
        Kp = 16.0d0
        Ki = 16.0d0
        Kd = 0.0d0
      else if (tim.gt.69.0d0) then
        SP = 99000.d0
        Kp = 18.0d0
        Ki = 18.0d0
        Kd = 0.0d0
      else if (tim.gt.32.0d0) then
        SP = 76000.d0
        Kp = 18.0d0
        Ki = 18.0d0
        Kd = 0.0d0
...
c...  ------------------------------------------------------------------
      ...
      if (time(2) > 0 .and. time(2) < 25) then
            phig = 0.d0
      end if

      if (time(2) > 32 .and. time(2) < 62) then
            phig = 0.d0
      end if

      if (time(2) > 69 .and. time(2) < 85) then
            phig = 0.d0
      end if

      if (time(2) > 92 .and. time(2) < 99) then
            phig = 0.d0
      end if

      if (time(2) > 106 .and. time(2) < 113) then
            phig = 0.d0
      end if

      if (time(2) > 120 .and. time(2) < 132) then
            phig = 0.d0
      end if

      if (time(2) > 139 .and. time(2) < 149) then
            phig = 0.d0
      end if

      if (time(2) > 163 .and. time(2) < 170) then
            phig = 0.d0
      end if
