function [new_node_9999, NewExpNodes] = Ped_2L_UpdateExpanderNodes_V1(original_mesh_nodes, original_mesh_elements, expd_pts_and_normals, offset, theta)
...
edge_nodes(1,:) = [linspace(1,60,60) linspace(61,2440,40) linspace(2501,2442,60) linspace(2441, 62, 40)];
...
%Offset x towards (-) or away (+) from the skin surface %%THIS CAN CHANGE
...
% Define bottom layer as 1mm away from the top layer (CHECK THIS IF THERE
% IS AN ERROR)
...
new_node_9999 = x(1508,:) + 0.5*average_point_cloud_normal;
