...
c      SP = 60000.d0
      ...
      if (tim.gt.280.0d0) then
        SP = 232000.d0
        Kp = 0.5d0
        Ki = 0.5d0
        Kd = 0.0d0
      else if (tim.gt.269.0d0) then
        SP = 232000.d0
        Kp = 1.0d0
        Ki = 1.0d0
        Kd = 0.0d0
      else if (tim.gt.258.0d0) then
        SP = 226000.d0
        Kp = 1.0d0
        Ki = 1.0d0
        Kd = 0.0d0
      else if (tim.gt.247.0d0) then
        SP = 220000.d0
        Kp = 1.0d0
        Ki = 1.0d0
        Kd = 0.0d0
      else if (tim.gt.236.0d0) then
        SP = 214000.d0
        Kp = 1.0d0
        Ki = 1.0d0
        Kd = 0.0d0
      else if (tim.gt.221.0d0) then
        SP = 208000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.206.0d0) then
        SP = 202000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.194.0d0) then
        SP = 196000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.182.0d0) then
        SP = 182000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.170.0d0) then
        SP = 168000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.155.0d0) then
        SP = 154000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.140.0d0) then
        SP = 144000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.125.0d0) then
        SP = 133000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.110.0d0) then
        SP = 122000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.95.0d0) then
        SP = 111000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.80.0d0) then
        SP = 100000.d0
        Kp = 1.5d0
        Ki = 1.5d0
        Kd = 0.0d0
      else if (tim.gt.58.0d0) then
        SP = 82000.d0
        Kp = 4.5d0
        Ki = 4.5d0
        Kd = 0.0d0
      else if (tim.gt.34.0d0) then
        SP = 60000.d0
        Kp = 4.5d0
        Ki = 4.5d0
        Kd = 0.0d0
...
c        porepres= porepres_pre + output/8400000.d0 !new pres for 50cc
        if (tim.gt.24.0d0) then
c          porepres= porepres_pre + output/5000000.d0 !new pres for 50cc
          porepres= porepres_pre + output/2000000.d0 !new pres for 50cc
        else if (tim.gt.0.05d0) then
c          porepres= porepres_pre + output/8500000.d0 !new pres for 50cc
          porepres= porepres_pre + output/2000000.d0 !new pres for 50cc
        else
          porepres= porepres_pre + output/5000000.d0 !new pres for 50cc
        end if
...
c...  variables passed in for information
      real*8  time(2), dtime, coords(3), props(nprops), dfgrd1(3,3), predef(3)
...
c...  ------------------------------------------------------------------
      ...
      if (time(2) > 0 .and. time(2) < 10) then
            phig = 0.d0
      end if

      if (time(2) > 34 .and. time(2) < 44) then
            phig = 0.d0
      end if

      if (time(2) > 58 .and. time(2) < 66) then
            phig = 0.d0
      end if

      if (time(2) > 80 .and. time(2) < 88) then
            phig = 0.d0
      end if

      if (time(2) > 95 .and. time(2) < 103) then
            phig = 0.d0
      end if

      if (time(2) > 110 .and. time(2) < 118) then
            phig = 0.d0
      end if

      if (time(2) > 125 .and. time(2) < 133) then
            phig = 0.d0
      end if

      if (time(2) > 140 .and. time(2) < 148) then
            phig = 0.d0
      end if

      if (time(2) > 155 .and. time(2) < 163) then
            phig = 0.d0
      end if

      if (time(2) > 170 .and. time(2) < 175) then
            phig = 0.d0
      end if

      if (time(2) > 182 .and. time(2) < 187) then
            phig = 0.d0
      end if

      if (time(2) > 194 .and. time(2) < 199) then
            phig = 0.d0
      end if

      if (time(2) > 206 .and. time(2) < 214) then
            phig = 0.d0
      end if

      if (time(2) > 221 .and. time(2) < 229) then
            phig = 0.d0
      end if

      if (time(2) > 236 .and. time(2) < 240) then
            phig = 0.d0
      end if

      if (time(2) > 247 .and. time(2) < 251) then
            phig = 0.d0
      end if

      if (time(2) > 258 .and. time(2) < 262) then
            phig = 0.d0
      end if

      if (time(2) > 269 .and. time(2) < 273) then
            phig = 0.d0
      end if

	  if (time(2) > 280 .and. time(2) < 284) then
            phig = 0.d0
      end if
 ...
 200    continue
        if (time(2).gt.0) then
          ...
          dot_theg = kk*(the/theg-tcr)
          dot_theg_dtheg = -kk*the/(theg**2.d0)
